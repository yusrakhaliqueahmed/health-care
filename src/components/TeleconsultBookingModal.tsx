...
export const TeleconsultBookingModal: React.FC<TeleconsultBookingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto p-3 sm:p-4 flex items-center justify-center bg-slate-950/70 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="relative w-full max-w-lg bg-white dark:bg-slate-900 rounded-2xl sm:rounded-3xl p-5 sm:p-7 shadow-2xl border border-slate-200 dark:border-slate-800 space-y-4 my-auto max-h-[min(94vh,640px)] overflow-y-auto animate-in zoom-in-95 duration-200">
